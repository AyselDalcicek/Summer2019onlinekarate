...
#/sign?email=teacherva5@gmail.com&password=maxpayne
  ...
  Scenario: Add new student
    ...
    * header Authorization = token
    * params {first-name:'Aysel', last-name:'Dalcicek', email:'aysel@email.com', password:'2222', role:'student-team-member', campus-location:'VA', batch-number: 12, team-name:'Online_Hackers'}
    * request 'test'
    When method post
    Then status 201
    And print response
